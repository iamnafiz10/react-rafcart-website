        ...
        <>
            <section id="recommended-section">
                <div className="container py-12">
                    <h2 className="text-3xl font-bold text-gray-800 uppercase mb-6">RECOMMENDED FOR YOU</h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {
                            allProducts.slice(6, 14).map((allProduct, index) => (
                                <div key={index} className="col bg-white shadow rounded overflow-hidden group">
                                    <div className="product-image relative">
                                        <img data-aos="zoom-in" data-aos-duration="1000" src={allProduct.image}
                                             className="w-full" alt="ProductImage"/>
                                        <div
