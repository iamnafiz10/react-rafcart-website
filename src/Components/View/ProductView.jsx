...
import {AiOutlineHome, AiOutlineRight, AiFillStar} from "react-icons/ai";
import {BsCart2, BsChevronLeft, BsChevronRight, BsStarHalf} from "react-icons/bs";
...
function ProductView(props) {
    ...
    useEffect(() => {
        const filtered = getAllProductData().filter(product => product.id == id);
        if (filtered.length) {
    ...
    // 👇 Pop Up Quantity Always 1 When User Open
    useEffect(() => {
        if (popUpToggle) { // popup is open
            setQuantity(1);
        }
    }, [popUpToggle]);
    ...
    return (
        <>
            <section id="product-view-section">
                    ...
                    <div className="full-wrap">
                        ...
                        <div className="wrap">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    <div className="col">
                                        <div className="product-single-image">
                                            <img src={product.images[activeImageIndex]} className="w-full"
                                                 alt="SliderImage"/>
                                        </div>
                                                    ...
                                                    product.images.map((image, index) => (
                                                        <div key={index}>
                                                            <img src={image} alt="productImage"
                                                                 width="100"
                                                                 className={`border ${activeThumbnailIndex === index ? 'border-primary' : ''}`}
                                    ...
                                    <div className="col">
                                        <div className="product-content">
                                            ...
                                            <div className="price flex items-baseline mb-1 mt-4 space-x-2 font-nato">
                                                <p className="text-2xl text-primary font-bold">
                                                    ${product.price * quantity}
                                                </p>
                                                <p className="text-md text-gray-400 line-through">$ {product.regularPrice}</p>
                                            </div>
                                            ...
                                            <div className="size-filter pt-6">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="size-selector">
                                                        <input type="radio" defaultChecked name="size" id="size-s"
                                                               className="hidden"/>
                                            ...
                                            <div className="color-filter pt-6">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="color-selector">
                                                        <input type="radio" defaultChecked name="color" id="color-black"
                                                               className="hidden"/>
                            ...
                            <div className="container pb-16">
                                <h3 className='text-xl border-b border-gray-200 font-nato text-gray-800 pb-3 font-medium'>
                                    Product Details
                                </h3>
                                <div className="w-full lg:w-3/5 pt-6">
                                    ...
                                    <table
                                        className="table-auto border-collapse w-full text-left text-gray-600 font-sm mt-6">
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td className="py-2 px-4 border border-gray-300">0.5kg</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                ...
                <div className="container py-8">
                    <h2 className="text-3xl font-bold text-gray-800 uppercase mb-6">Related Products</h2>
