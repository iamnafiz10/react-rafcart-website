                        ...
                        <div className="col-span-12 lg:col-span-3">
                            ...
                            <div
                                ...
                                <div className="space-y-2 pl-8">
                                    ...
                                    <Link to='/address' className="block text-md text-primary capitalize hover:text-primary transition-all">
                                        Manage Address
                                    </Link>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="form-control">
                                        <label htmlFor="full_name" className="text-gray-600 mb-2 block">
                                            Full Name
                                        </label>
                                        <input type="text" className="input-box" placeholder="Roshan Nafiz"/>
                                    </div>
                                    ...
                                    <div className="form-control">
                                        ...
                                        <input type="text" className="input-box" placeholder="01321764096"/>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="form-control">
                                        <label htmlFor="email_address" className="text-gray-600 mb-2 block">
                                            Email
                                            Address
                                        </label>
                                    ...
                                    <div className="form-control">
                                        <label htmlFor="gender" className="text-gray-600 mb-2 block">Country</label>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="form-control">
                                        ...
                                        <select name="region" className="input-box">
                                    ...
                                    <div className="form-control">
                                        <label htmlFor="zip_code" className="text-gray-600 mb-2 block">Zip Code</label>
                                        <input type="text" className="input-box" placeholder="6253"/>
                                    </div>
